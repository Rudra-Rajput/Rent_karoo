...
const Otp = ({navigation}) => {
  ...
  return (
    <View style={styles.mainContainer}>
     ...
     <View style={{flexDirection: 'row', justifyContent: 'space-around', marginTop: '10%', width: '100%', alignSelf: 'center'}}>
        <TextInput
         ref={pin1Ref}
         mode='outlined'
     ...
     <View style={{position: 'absolute', bottom: 10, width: '100%'}}>
        <Button onPress={() => navigation.navigate('Main')} title={'Login'} backgroundColor={'#1631b8'}/>
     </View>
